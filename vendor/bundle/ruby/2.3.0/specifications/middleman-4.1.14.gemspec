# -*- encoding: utf-8 -*-
# stub: middleman 4.1.14 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<middleman-core>.freeze, ["= 4.1.14"])
      s.add_runtime_dependency(%q<middleman-cli>.freeze, ["= 4.1.14"])
      ...
      s.add_dependency(%q<middleman-core>.freeze, ["= 4.1.14"])
      s.add_dependency(%q<middleman-cli>.freeze, ["= 4.1.14"])
